...
import type { Department, Team, Media as MediaType } from '@/payload-types'
  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto px-6 md:px-12 overflow-hidden">
      <div className="flex flex-col mb-12 gap-y-4">
        ...
        <div className="flex items-center font-brand text-[16px] font-normal leading-[24px] tracking-[0%] text-center w-[418.703125px] mx-auto">
          {introText}
        </div>
      </div>
      ...
      <div
        ...
        className="flex gap-[10px] overflow-x-auto pb-4 cursor-grab select-none no-scrollbar"
        style={{
          width: 'calc(100% + 48px)',
          marginRight: '-24px',
          paddingRight: '48px',
        ...
        {departments.map((dept, i) => {
          ...
          return (
            <div
              ...
              className={`relative h-[420px] shrink-0 overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.34,1.3,0.64,1)] outline outline-1
                ${isActive ? 'w-[800px] shadow-[0_24px_64px_rgba(255,194,44,0.15)] outline-[#ffc22c]/20' : 'w-[227px] outline-white/10'}
                ...
                <div className="flex-1 relative overflow-hidden">
                  ...
                  >
                    {currentMembers.map((member) => (
                      <div key={member.id} className="relative group overflow-hidden bg-[#1a1a1a]">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-3">
                          ...
                          <p className="font-brand text-[12px] font-normal leading-[120%] tracking-[1%] text-center text-white/60 capitalize">
                            {member.role}
                          </p>
                        </div>
                      </div>
