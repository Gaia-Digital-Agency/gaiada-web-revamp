...
export const AIChatPopup: React.FC<Props> = ({ onClose }) => {
  ...
  return (
    <div
      ...
      className="fixed bottom-24 right-6 z-50 w-[min(92vw,380px)] bg-background text-foreground rounded-2xl shadow-2xl border border-border overflow-hidden flex flex-col max-h-[70vh]"
    >
